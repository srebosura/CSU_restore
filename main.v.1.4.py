...
class embeddedTerminal(QWidget):
    ...
    def _read_info(self):
		...
		ser.close()
		time.sleep(3)
		self.elid_r = os.popen4('python exec_cmd.py "cat /data/etc/ELID" 10 |tail -2 |head -1')[1].read()
		self.elidEdit.setText(self.elid_r)
		self.housing_r = os.popen4('python exec_cmd.py "cat /data/etc/HOUSING" 10 |tail -2 |head -1')[1].read()
		self.housingEdit.setText(self.housing_r)
		
		self.vbat1_r = os.popen4('python exec_cmd.py "csu_pwrctrl -g vbat1" 10 |tail -2 |head -1')[1].read()
		self.vbat2_r = os.popen4('python exec_cmd.py "csu_pwrctrl -g vbat2" 10 |tail -2 |head -1')[1].read()	
		self.imain_r = os.popen4('python exec_cmd.py "csu_pwrctrl -g imain" 10 |tail -2 |head -1')[1].read()
		self.vbat_r = os.popen4('python exec_cmd.py "csu_pwrctrl -g vbat" 10 |tail -2 |head -1')[1].read()
		self.batsel_r = os.popen4('python exec_cmd.py "csu_pwrctrl -g batsel" 10 |tail -2 |head -1')[1].read()
		...
		self.csac_r = os.popen4('python exec_cmd.py "sq_disciplining --telemetry" 10 >/tmp/csu.tmp')[1].read()
...
if __name__ == "__main__":
    ...
    main.setWindowTitle("CSU Restore v1.4                                                           Case Abyss 3                                                            SeaBed GeoSolutions")
